...
class Student
{
	...
	public:
		...
		/* if the student fails the class, then display the student's name 
		 * otherwise, do nothing */
		 
		void displayIfPass() const;
		/* if the student passes the class, then display the student's name 
		 * otherwise, do nothing */
		...
		/* show the student's name with the last name first, followed by
